...
public class HotelReservationGUI extends JFrame {
    ...
    private void createAndShowGUI() {
        ...
        saveButton.addActionListener(this::saveReservations);
    ...
    private void loadRoomDataFile() {
        ...
        if (filePath != null) {
            displayArea.setText("File selected: " + filePath);
            // Additional logic to process the file can be implemented here
        } else {
            displayArea.setText("File selection cancelled.");
        }
    }
